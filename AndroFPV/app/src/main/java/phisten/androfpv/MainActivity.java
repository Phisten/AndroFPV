...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scp.UiHandler = handler;

        //UI Init
        UI_EditText_TargetIp = (EditText) findViewById(R.id.IpText);
        ...
        ConnectBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //向指定IP請求masterCh連接
                //EditText ipEditText = (EditText) findViewById(R.id.IpText);
                String hostIp = UI_EditText_TargetIp.getText().toString();

                makeTextAndShow(getApplicationContext(),"TryConnect IP = " + hostIp,Toast.LENGTH_SHORT);
                scp.MasterChannelConnect(hostIp);
            }
        });
    ...
    private Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SocketChannelPool.HANDLERMSG_SHOWTEXT:
                    Log.d(LogTag.OutputTest, "handleMessage: " + MsgString);
                    makeTextAndShow(getApplicationContext(), MsgString ,Toast.LENGTH_SHORT);
                    break;
                case SocketChannelPool.HANDLERMSG_SET_TARGET_IP:
                    Log.d(LogTag.OutputTest, "SetTargetIP: " + MsgString);
                    UI_EditText_TargetIp.setText(MsgString);
                    makeTextAndShow(getApplicationContext(), MsgString ,Toast.LENGTH_SHORT);
                    break;
